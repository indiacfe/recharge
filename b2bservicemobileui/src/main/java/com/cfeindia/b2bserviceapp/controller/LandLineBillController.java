...
import com.cfeindia.b2bserviceapp.dto.LandLineBillDto;
...
public class LandLineBillController {
	...
	public ModelAndView doDataCardRecharge(@RequestBody String body) {
		...
		return new ModelAndView(XML_VIEW_NAME, "landLineBillPay", outcome);
	}
