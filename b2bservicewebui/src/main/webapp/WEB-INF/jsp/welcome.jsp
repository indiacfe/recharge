			...
			<div class="header-right">
				<div>
					<ul class="header-li">
						...
						<li><a href="mailto:help@cybertelindia.com"><i
			...
			<div class="row">
				...
				<div class="col-md-8">
					<div id="slider2_container"
						style="position: relative; width: 790px; height: 370px;">
						...
						<!-- Slides Container -->
						<div u="slides"
							style="cursor: move; position: absolute; left: 0px; top: 0px; width: 790px; height: 370px; overflow: hidden;">
							<%-- <div>
								<a u=image href="#"><img
									src="${base_url}img/landscape/04.jpg" /></a>
							</div> --%>
							<div>
								<a u=image href="#"><img
					...
					<div class="feature-login-form">
						...
						<form class="form-horizontal" id="form" name="form" method="post"
							...
							<div class="name-select">
								<label for="inputSelect" class="text-color-white">Select</label>
