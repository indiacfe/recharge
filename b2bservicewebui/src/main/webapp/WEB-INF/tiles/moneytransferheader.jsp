...
<div class="grid_12">
	<ul class="nav main">
		...
		<div class="block " style="width: 1051px; margin-left: 228px; margin-top: 0px; border-top-width: 0px; height: 20px;"> 
				...
				<table>
				<tr>
				<td><a href="registrationotp"><input type="button" value="REGISTRATION"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></td>
				<td><a href="reloadotp"><input type="button" value="RELOAD WALLET"/></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
				<td><a href="remittanceotp"><input type="button" value="REMITANCE"/></a></td>
				</tr>
				</table>
				</div>
