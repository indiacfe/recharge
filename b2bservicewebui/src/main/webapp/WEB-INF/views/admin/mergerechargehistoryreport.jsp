...
<div class="grid_10">
	<div class="box round first">
		<h2>Merge Recharge Report</h2>
		<div class="block ">
			<form method="post" action="mergerechargehistoryreport"
			...
			<div class="box round first grid">
				...
				<div class="block">
					...
					<form method="post" action="AdminMergeRechargeHistory"
						id="mergereportdata">
						...
						<input type="hidden" id="fDate" name="fromDate"
							...
							id="tParty" name="thirdPartyName" /> <input type="hidden" id="cust"
							name="customerId" /> <input type="hidden" id="stata" name="status"
							value="${status}" />
