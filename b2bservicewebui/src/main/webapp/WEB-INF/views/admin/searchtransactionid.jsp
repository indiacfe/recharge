...
<script type="text/javascript">
	...
	function seeAll() {
		window.location.href = "allrefundrequests";
	}
</script>
<div class="grid_10">
	<div class="box round first">
		...
		<div class="block ">
			...
			<form:form method="post" action="transactiondetail">
				<table class="form">
					<tbody>
					...
					<table class="form">
						<c:forEach items="${detailForRefund}" var="refund"
							...
							<tbody>
								...
								<tr>
									<td align="col1">SERVICE PROVIDER :</td>
									<td align="col2">${refund.thirdPartyServiceProviderName}</td>
								</tr>
								<tr>
								...
								<tr>
									<td><input type="hidden" name="id" value="${refund.id}">
										...
										value="${refund.retailerId}"> <input type="hidden"
										name="amount" value="${refund.amount}"> <input
										type="hidden" name="creditAmount"
