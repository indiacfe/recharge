...
<script type="text/javascript">
	...
	function exeldoc() {
		...
		var thirdparty2 = document.getElementById("selcust").value;
		document.getElementById("cust").value = thirdparty2;
		
		var getexel = document.getElementById("mergereportdata");
...
<div class="grid_10">
	<div class="box round first">
		<h2>Operator Wise Recharge Report</h2>
		<div class="block ">
			<form method="post" action="operatorwisereport"
				...
				<table class="form">
					<tbody>
						...
						<tr>
							...
							<td class="col2"><select name="operator" id="operator">
									<option value="ALL">ALL</option>
									<c:forEach items="${operatorname}" var="operators"
										varStatus="status">
						...
						<tr>
							...
							<td class="col2"><select name="customerId" id="selcust">
									<option value="ALL">ALL</option>
			...
			<div class="box round first grid">
				...
				<div class="block">
					...
					<form method="post" action="AdminOperatorWiseRechargeHistory"
						id="mergereportdata">

						<input type="hidden" id="fDate" name="fromDate"
							value="${fromdate}" /> <input type="hidden" id="tDate"
							name="toDate" value="${todate}" /> <input type="hidden"
							id="tParty" name="thirdPartyName" /> <input type="hidden"
							id="cust" name="customerId" /> <input type="hidden" id="stata"
							name="status" value="${status}" /><input type="hidden"
							id="operat" name="operator" value="${indivOperator}"/>
