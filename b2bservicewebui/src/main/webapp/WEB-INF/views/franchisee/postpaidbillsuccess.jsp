...
<script type="text/javascript">
	function rechargeAgain() {
		window.location.href = "postpaidbillpayment";
	}
	...
	function print() {
		...
		var prtContent = '<fieldset><legend>Transaction Details</legend><table><tr><td>Type:</td><td>Postpaid Bill Payment</td></tr><tr><td>Date-Time:</td><td>'
				+ dateTime
...
<div class="grid_10">
	<div class="box round first">
		<h2>
			<label style="font-size: 20px;">Post Paid Bill Payment Detail</label>
		</h2>
		<div class="block ">
			...
			<table class="form">
				<tbody>
					...
					<tr>
						<td><label
							style="font-size: 20px; color: #CC0000;">Mobile Number::</label></td>
						<td><label
					...
					<tr>
						<td align="center"><input type="submit" name="submit" class="btn btn-large"
							value="Print" onclick="window.print()" style="width: 101px"/></td>
						<td><input type="submit"
							name="submit" class="btn btn-large" value="Recharge Again"
