...
<script type="text/javascript">
	function rechargeAgain() {
		window.location.href = "waterbill";
	}
	...
	function print() {
		...
		var prtContent = '<fieldset><legend>Transaction Details</legend><table><tr><td>Type:</td><td>Gas Bill Payment</td></tr><tr><td>Date-Time:</td><td>'
				+ dateTime
				+ '</td></tr><tr><td>KN No.:</td><td>'
				+ connectionId
...
<div class="grid_10">
	<div class="box round first">
		<h2>
			<label style="font-size: 20px;">Water Bill Payment Detail</label>
		</h2>
		<div class="block ">
			...
			<table class="form">
				<tbody>
					...
					<tr>
						<td><label style="font-size: 20px; color: #CC0000;">KN Number:</label></td>
						<td><label style="font-size: 20px; color: #CC0000;">${connectionid}</label></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><input type="submit" name="submit" class="btn btn-large"
							value="Pay Again" onclick="rechargeAgain();" /></td>
					</tr>
