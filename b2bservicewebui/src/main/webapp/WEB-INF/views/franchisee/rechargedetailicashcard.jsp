...
<script type="text/javascript">
	function rechargeAgain() {
		window.location.href = "icashcardrecharge";
	}
...
<div class="grid_10">
	<div class="box round first">
		<h2>
			<label style="font-size: 20px;">Icash Card Recharge Detail</label>
		</h2>
		<div class="block ">
			...
			<table class="form">
				<tbody>
					...
					<tr>
						<td><label style="font-size: 20px; color: #CC0000;">Recharge:</label></td>
