...
<div class="grid_10">
	<div class="box round first">
		<h2>
			<label style="font-size: 20px;">Water Bill Payment</label>
		</h2>
		<div class="block ">
			...
			<p style="font-size: 19px;">Note: Please verify the connection
				...
				recharges</p>
			<form:form method="POST" action="waterbillsubmit"
				onSubmit="return validateFormSubmit()" modelAttribute="waterbillbean">
				<table class="form">
					<%
