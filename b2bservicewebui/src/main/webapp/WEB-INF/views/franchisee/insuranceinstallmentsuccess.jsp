...
function rechargeAgain() {
	window.location.href = "insurancepremium";
}
...
function print() {
	...
	var prtContent = '<fieldset><legend>Transaction Details</legend><table><tr><td>Type:</td><td>Insurance Premium Bill Payment</td></tr><tr><td>Date-Time:</td><td>'
			+ dateTime
			+ '</td></tr><tr><td>Policy Number:</td><td>'
			+ connectionId
...
<div class="grid_10">
	<div class="box round first">
		<h2><label style="font-size: 20px;">Insurance Premium Bill Payment Detail</label></h2>
		<div class="block ">
			...
			<table class="form">
				<tbody>
					...
					<tr>
						<td><label
							style="font-size: 20px; color: #CC0000;">Policy Number:</label></td>
						<td><label
