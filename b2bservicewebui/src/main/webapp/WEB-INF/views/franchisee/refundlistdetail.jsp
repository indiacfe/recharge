		...
		<div class="block ">
			...
			<table class="form">
				<tbody>
					...
					<tr>
						<td><label style="font-size: 20px; color: #CC0000;">Refund Amount(Rs.):</label></td>
						<td><label style="font-size: 20px; color: #CC0000;">Rs.${refundetails.refundAmount}</label></td>
					</tr>
					
					<tr>
						<td><label style="font-size: 20px; color: #CC0000;">Credit Amount(Rs.):</label></td>
						<td><label style="font-size: 20px; color: #CC0000;">Rs.${refundetails.creditAmountFranchisee}</label></td>
					</tr>
					<tr>
						<td><label style="font-size: 20px; color: #CC0000;">Mobile/Connection No.:</label></td>
					...
					<td></td>
						<td align="center"><input type="submit" name="submit"
							class="btn btn-large" value="Go Back" onclick="javascript: history.go(-1);"
