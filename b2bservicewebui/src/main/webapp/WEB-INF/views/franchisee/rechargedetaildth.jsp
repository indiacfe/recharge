...
<script type="text/javascript">
	function rechargeAgain() {
		window.location.href = "tvrecharge";
	}
	...
	function print() {
		...
		var prtContent = '<fieldset><legend>Transaction Details</legend><table><tr><td>Type:</td><td>DTH Recharge</td></tr><tr><td>Date-Time:</td><td>'
				+ dateTime
...
<div class="grid_10">
	<div class="box round first">
		<h2>
			<label style="font-size: 20px;">Recharge Detail</label>
		</h2>
		<div class="block">
			...
			<table class="form">
				<tbody>
					...
					<tr>
						<td><label style="font-size: 20px; color: #CC0000;">DTH:</label></td>
					...
					<tr>
						...
						<td><label style="font-size: 20px; color: #CC0000;">${amount}</label></td>
					</tr>
					<tr>
