...
<script type="text/javascript">
	function rechargeAgain() {
		window.location.href = "dataCardrecharge";
	}
	function print() {
		...
		var prtContent = '<fieldset><legend>Transaction Details</legend><table><tr><td>Type:</td><td>Data Card Recharge</td></tr><tr><td>Date-Time:</td><td>'
				+ dateTime
...
<div class="grid_10">
	<div class="box round first">
		<h2><label style="font-size: 20px;">Recharge Detail</label></h2>
		<div class="block ">
			...
			<table class="form">
				<tbody>
					...
					<tr>
						<td><label
							style="font-size: 20px; color: #CC0000;">Data Card Number:</label></td>
						<td><label
