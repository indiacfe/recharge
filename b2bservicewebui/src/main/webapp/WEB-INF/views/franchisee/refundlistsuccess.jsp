		...
		<div class="block" id="toDate">
			<c:if test="${not empty refundlist }">
					...
					<tbody>
						<c:forEach items="${refundlist}" var="requestItem"
							...
							<tr class="odd gradeX">
								...
								<td><form method="GET" action="refundalllistdetails">
										<input type="hidden" name="tid" value="${requestItem.transId}">
				...
				<input type="button" class="button" value="Download Excel Document"
					onclick="window.location.href='RetailerCommissionRequest'" />
