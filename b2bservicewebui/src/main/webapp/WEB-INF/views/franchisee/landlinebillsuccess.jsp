...
function rechargeAgain() {
	window.location.href = "landlinebill";
}
...
function print() {
	...
	var prtContent = '<fieldset><legend>Transaction Details</legend><table><tr><td>Type:</td><td>Landline Bill Payment</td></tr><tr><td>Date-Time:</td><td>'
			+ dateTime
...
<div class="grid_10">
	<div class="box round first">
		<h2><label style="font-size: 20px;">Land Line Bill Payment Detail</label></h2>
		<div class="block ">
			...
			<table class="form">
				<tbody>
					...
					<tr>
						<td><label
							style="font-size: 20px; color: #CC0000;">Land Line Number:</label></td>
						<td><label
