...
<script type="text/javascript">
	function getCommission() {
		...
		if (paymentType != -1 && operator != -1 && ammount != null) {
			$
					.ajax({
...
<div class="grid_10">
	<div class="box round first">
		<h2>
			<label style="font-size: 20px;">Post Paid Bill Payment</label>
		</h2>
		<div class="block ">
			...
			<p style="font-size: 19px;">Note: Please verify the number before
				...
				wrong recharges</p>
			<form:form method="POST" action="postpaidbillsubmit"
				onSubmit="return validateFormSubmit()" modelAttribute="postpaidbean">
				<table class="form">
					<%
					...
					<tbody>
						...
						<tr>
							...
							<td><form:select path="operator" class="recharge-Select"
									id="operator" style="border-color:#CC0000;"
						...
						<tr>
							<td><label style="font-size: 20px; color: #CC0000;">Mobile/Phone
									Number</label></td>
