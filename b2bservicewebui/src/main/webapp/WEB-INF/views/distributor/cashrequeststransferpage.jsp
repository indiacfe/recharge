...
<div id="search_panel1">
	...
	<div style="color: red; left-padding: 80px;">${error}</div>
		<br />
	<form method="post" action="depositrequesttransfertofranchisee" onsubmit="return fundTransferFormValidation();">
		<table>
			<tr>
				<td>Retailer ID:</td>
...
<div class="grid_10">
	<div class="box round first">
		...
		<div class="block ">
			...
			<form method="post" action="depositrequesttransfertofranchisee"
				...
				<table class="form">
					<tbody>
						...
						<tr>
							<td><label>Data Card Number</label></td>
							<td><input class="inputfield" required="required"
									name="connectionid" id="connectionid"></input></td>
						</tr>
						<tr>
