...
<div class="grid_10">
	<div class="box round first">
		...
		<div class="block ">
			...
			<form:form method="post" action="registrationProcess"
					...
					<tbody>
						...
						<tr>
							...
							<td class="col2"><form:input class="inputfield"
									required="required" path="firmName" id="firmName"></form:input></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="col2"><form:textarea class="inputfield"
									path="officeAddress" id="officeAddress" required="required"></form:textarea></td>
							<td style="vertical-align: middle; padding-top: 0px;"><label>Permanent
									Address*:</label></td>
							<td class="col2"><form:textarea class="inputfield"
									path="permanentAddress" id="permanentAddress"
						...
						<%-- <tr>
							...
							<td class="col2"> <form:password class="inputfield" required="required" path="password"  id="password"></form:password></td>
							<td class="col1"><label>Confirm Password*:</label></td>
							<td class="col2"> <input class="inputfield" required="required" name="confirmPassword" type="password" id="confirmPassword"/></td>
						</tr> --%>
