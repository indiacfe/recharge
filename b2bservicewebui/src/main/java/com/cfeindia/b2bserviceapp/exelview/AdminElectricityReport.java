...
public class AdminElectricityReport extends AbstractExcelView {
	...
	protected void buildExcelDocument(Map<String, Object> model,
		...
		response.setHeader("Content-Disposition", "attachment; filename=Electricity Recharge History Summary.xlsx");
		List<ReportBeanDto> list = (List<ReportBeanDto>) model.get("list");
		HSSFSheet sheet = workbook.createSheet("Electricity Recharge History");
