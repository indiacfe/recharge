...
public class adminOperatorWiseRechargeReport extends AbstractExcelView {
	...
	protected void buildExcelDocument(Map<String, Object> model,
		...
		response.setHeader("Content-Disposition", "attachment; filename=Operator Wise Recharge History Summary.xlsx");
		List<ReportBeanDto> list = (List<ReportBeanDto>) model.get("list");
		HSSFSheet sheet = workbook.createSheet("Operator Wise Recharge History");
