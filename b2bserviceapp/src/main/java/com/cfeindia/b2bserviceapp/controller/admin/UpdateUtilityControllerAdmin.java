...
import com.cfeindia.b2bserviceapp.admin.model.UpdateAccountCompany;
import com.cfeindia.b2bserviceapp.admin.model.UpdateCommissionDistributor;
import com.cfeindia.b2bserviceapp.admin.model.UpdateCommissionOperator;
...
import com.cfeindia.b2bserviceapp.recharge.mobile.dto.ThirdpartyServiceProviderUpdateDTO;
...
public class UpdateUtilityControllerAdmin {
	...
	public ModelAndView updateUtility(ModelMap map) {
		...
		map.addAttribute("thirdpartyServiceProviderUpdateDTO", new ThirdpartyServiceProviderUpdateDTO());
		return model;
	...
	public String setDistributorCommission(
		...
		String distId = updateCommissionDistributor
				.getDistributorId();
	...
	public String setOperatorCommission(
		...
		String rechargeType = updateCommissionOperator.getRechargeType();
		String thirdPartyName = updateCommissionOperator
				.getThirdPartyOperator();
		String operatorName = updateCommissionOperator.getOperator();
		Double amount = updateCommissionOperator.getAmount();
		String check = adminUtilityService.setOperatorCommission(rechargeType,
				thirdPartyName, operatorName, amount);
		if (CommonConstants.SUCCESS.equalsIgnoreCase(check))
			return "redirect:successadmin";
		else
			return "failureAdmin";
	...
	public String setThirdPartyServiceProvider(@ModelAttribute("thirdpartyServiceProviderUpdateDTO")  ThirdpartyServiceProviderUpdateDTO thirdpartyServiceProviderUpdateDTO) {
		adminUtilityService.updateThirdPartyAPISelection(thirdpartyServiceProviderUpdateDTO.getRechargeType(),
				thirdpartyServiceProviderUpdateDTO.getOperatorName(), thirdpartyServiceProviderUpdateDTO.getThirdPartyName());
