...
<div id="search_panel1">
	<h1>Search Transaction Id</h1>
	<h2>${error}</h2>

	<form:form method="post" action="transactiondetail">
		<div class="search_panel_box">
			<div class="form_row">
				<label>Enter Transaction Number:</label> <input class="inputfield"
					name="tid" type="text" id="transId" />
			</div>
			<input type="submit" class="button" value="Submit" />
			<input class="button" type="button" value="See all" onclick="seeAll()">
		</div>
	</form:form>
</div>
