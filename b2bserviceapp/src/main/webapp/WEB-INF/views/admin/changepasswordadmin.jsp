...
<div id="search_panel1">
	...
	<h4>${error}</h4>
	<form:form method="post" action="changepasswordprocessadmin"
		onSubmit="return changePasswordValidation();" modelAttribute="changepass">
		<div class="search_panel_box">

			<div class="form_row">
				<label>Old Password</label>
				<form:password class="inputfield" required="required"
					path="oldPassword" id="oldPassword"></form:password>
			</div>

			<div class="form_row">
				<label>New Password</label>
				<form:password class="inputfield" required="required"
					path="newPassword" id="newPassword"></form:password>
			</div>

			<div class="form_row">
				<label>Confirm Password</label>
				<form:password class="inputfield" required="required"
					path="confirmPassword" id="confirmPassword"></form:password>
			</div>
