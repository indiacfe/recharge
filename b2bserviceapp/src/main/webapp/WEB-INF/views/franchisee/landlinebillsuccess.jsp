...
function print(){
	...
	var WinPrint = window.open('', '', 'letf=0,top=0,width=500,height=600,toolbar=0,scrollbars=0,status=0');
	...
	<h1>Land Line Bill Payment Detail</h1>
	
	<div class="form_action" id="printDiv">
		<form action="" style="text-align: left;">
			...
			<div class="form_row">
				<div class="tdElement">Land Line Number:</div>
