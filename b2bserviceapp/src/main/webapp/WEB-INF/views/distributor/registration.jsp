...
<div id="search_panel1">
        ...
        <h2>${error}</h2>
        <form:form method="post" action="registrationProcess"  onSubmit="return validation();" modelAttribute="registration">
          ...
          <form:input class="inputfield"  path="firmName"  id="firmName"></form:input>
           ...
           <div class="form_row">
          <label>Name*:</label>
          <form:input class="inputfield" required="required" path="name"  id="name"></form:input>
        </div>
        
        <div class="form_row">
          <label>Permanent Address:</label>
          <form:textarea class="inputfield" path="permanentAddress" id="permanentAddress"></form:textarea>
        </div>
            
            <div class="form_row">
          <label>Office Address:</label>
          <form:textarea class="inputfield" path="officeAddress"  id="officeAddress"></form:textarea>
        </div>
          ...
          <form:input class="inputfield" required="required" path="mobileNo"  id="mobileNo"></form:input>
        </div>
            
            <div class="form_row">
          <label>Password*:</label>
          <form:password class="inputfield" required="required" path="password"  id="password"></form:password>
        </div>
        
        <div class="form_row">
          <label>Confirm Password*:</label>
          <input class="inputfield" required="required" name="confirmPassword" type="password" id="confirmPassword"/>
        </div>
          ...
          <form:input class="inputfield" path="bankBranchCity"  id="bankBranchCity"></form:input>
        </div>
